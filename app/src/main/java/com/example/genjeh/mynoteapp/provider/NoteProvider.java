package com.example.genjeh.mynoteapp.provider;
...
import com.example.genjeh.mynoteapp.DatabaseContract;
import com.example.genjeh.mynoteapp.NoteHelper;
...
public class NoteProvider extends ContentProvider {
    ...
    static {
        uriMatcher.addURI(DatabaseContract.AUTHORITY, DatabaseContract.TABLE_NAME, NOTE);
        uriMatcher.addURI(DatabaseContract.AUTHORITY, DatabaseContract.TABLE_NAME + "/#", NOTE_ID);
    }
